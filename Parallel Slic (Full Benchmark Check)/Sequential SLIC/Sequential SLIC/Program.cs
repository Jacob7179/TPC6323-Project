...
const string OutputFolderPath = @"E:\TPC SPL\Parallel Slic (Full Benchmark Check)\Sequential SLIC\output";
...
{
    ImageRunResult result = ProcessImage(inputFolder, outputDir, inputPath, RunSequentialSlic);
    benchmark.Add(result.Timing);
    Console.WriteLine("Output: " + result.OutputPath);
}

executionStopwatch.Stop();
PrintBenchmark("Sequential", benchmark, executionStopwatch.Elapsed.TotalMilliseconds);
