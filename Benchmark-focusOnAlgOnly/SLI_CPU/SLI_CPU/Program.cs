...
WriteProfileFlag("CPU SLIC evaluation start");
...
foreach (string inputPath in inputPaths)
{
    ...
    WriteProfileFlag("CPU SLIC start: " + imageName);
    Stopwatch executionStopwatch = Stopwatch.StartNew();
    using (EnterProfileSpan("CPU SLIC execution: " + imageName))
    {
        Stopwatch processingStopwatch = Stopwatch.StartNew();
        using (EnterProfileSpan("CPU SLIC processing: " + imageName))
        {
    ...
    WriteProfileFlag("CPU SLIC end: " + imageName);
...
WriteProfileFlag("CPU SLIC evaluation end");
