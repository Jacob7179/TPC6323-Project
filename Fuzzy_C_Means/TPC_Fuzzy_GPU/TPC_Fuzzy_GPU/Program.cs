...
{
    ImageRunResult result = ProcessImage(inputFolder, outputDir, inputPath, RunGpuFuzzyCMeans);
...
static ImageRunResult ProcessImage(string inputFolder, string outputDir, string inputPath, Func<ImageData, int[]> runSegmentation)
{
