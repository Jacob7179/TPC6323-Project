...
const string InputFolderPath = @"C:\Users\Nitro\Downloads\TPC6323-Project-main\TPC6323-Project-main\SLIC\TPC Preprocessing\Preprocess Dataset"; // Put the folder containing preprocessed grayscale images here.
const string OutputFolderPath = @"C:\Users\Nitro\Downloads\TPC6323-Project-main\TPC6323-Project-main\SLIC\Parallel Slic (Full Benchmark Check)\SLI_CPU\output";
const string GroundTruthMaskFolderPath = @"C:\Users\Nitro\Downloads\TPC6323-Project-main\TPC6323-Project-main\SLIC\Grad-CAM-based pseudo ground truth";
...
{
    ImageRunResult result = ProcessImage(inputFolder, outputDir, groundTruthFolder, inputPath, RunCpuParallelSlic);
...
PrintMseSummary("CPU", mseSummary);
...
static int[] RunCpuParallelSlic(ImageData image)
{
    ...
    float spatialWeight = settings.SpatialWeight;
